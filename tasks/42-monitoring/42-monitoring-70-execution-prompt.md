...
You are implementing the `@agency/monitoring` package per the specification in `01-monitoring-spec.md`. This is a **foundational package** that `@agency/monitoring-rum` will build upon.
...
- `01-monitoring-spec.md` - Full specification
- `02-monitoring-constraints.md` - Technical/budget limits
- `03-monitoring-adr-provider.md` - Why provider abstraction
- `04-monitoring-guide-integration.md` - How to use the package
- `05-monitoring-qa-checklist.md` - Validation criteria
