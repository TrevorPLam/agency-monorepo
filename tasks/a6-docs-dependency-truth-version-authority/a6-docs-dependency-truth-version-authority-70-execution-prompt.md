...
1. `docs/tasks/a6-docs-dependency-truth-version-authority/00-docs-dependency-truth-version-authority-overview.md`
2. `docs/tasks/a6-docs-dependency-truth-version-authority/01-docs-dependency-truth-version-authority-spec.md`
