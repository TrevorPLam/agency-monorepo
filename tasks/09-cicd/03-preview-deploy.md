# 09-cicd/03-preview-deploy: Preview Deployment Workflow (`.github/workflows/preview.yml`)

## Purpose
Deploy preview environments for Pull Requests. Every PR gets a unique URL for testing.
