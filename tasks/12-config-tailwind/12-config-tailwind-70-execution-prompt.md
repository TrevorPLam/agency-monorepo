...
- `@/docs/tasks/12-config-tailwind/01-tailwind-spec.md` — Technical specification
- `@/docs/tasks/12-config-tailwind/04-tailwind-guide-setup.md` — Setup guide
- `@/docs/tasks/12-config-tailwind/05-tailwind-qa-checklist.md` — QA checklist
