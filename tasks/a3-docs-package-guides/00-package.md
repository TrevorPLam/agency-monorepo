# a3-docs-package-guides/00-package: Package Guides Documentation
...
- TASK_21 (AI Agent Rules) - agents read these guides
- TASK_32 (Root README) - links to these guides
