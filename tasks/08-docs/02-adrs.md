# 08-docs/02-adrs: Architecture Decision Records (`docs/architecture/ADRs/`)

## Purpose
Document significant architectural decisions with context, consequences, and rationale. ADRs provide historical context for why the codebase is structured as it is.
