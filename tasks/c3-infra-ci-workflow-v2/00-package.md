# c3-infra-ci-workflow-v2/00-package: CI Workflow

## Purpose
Quality gate for the entire monorepo. Runs build, lint, test, and typecheck using Turborepo affected-only execution and remote caching.
