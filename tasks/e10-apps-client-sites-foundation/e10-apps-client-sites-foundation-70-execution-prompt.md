...
1. `docs/tasks/e10-apps-client-sites-foundation/00-apps-client-sites-foundation-overview.md`
2. `docs/tasks/e10-apps-client-sites-foundation/01-apps-client-sites-foundation-spec.md`
3. `docs/tasks/e4-apps-client-portal/` if the surface is authenticated
