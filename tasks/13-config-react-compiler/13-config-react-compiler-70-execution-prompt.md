...
- `@/docs/tasks/13-config-react-compiler/01-config-react-compiler-spec.md` — Technical spec
- `@/docs/tasks/13-config-react-compiler/04-react-compiler-guide-migration.md` — Migration guide
- `@/docs/tasks/13-config-react-compiler/05-react-compiler-qa-checklist.md` — QA checklist
