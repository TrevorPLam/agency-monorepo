...
| File | Purpose |
|------|---------|
| `32-ui-design-system-10-spec.md` | Implementation with CVA patterns and testing |
| `32-ui-design-system-20-constraints.md` | Package boundaries and component rules |
