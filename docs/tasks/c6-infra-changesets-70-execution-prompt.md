...
Implement the root Changesets configuration described in `c6-infra-changesets-10-spec.md`.
...
- `.changeset/01-config-biome-migration-50-ref-quickstart.md` explains how to create, review, and skip changesets.
