...
1. `docs/tasks/60-auth-internal-00-overview.md` — Purpose and scope
2. `docs/tasks/60-auth-internal-10-spec.md` — Implementation spec
3. `docs/tasks/60-auth-internal-20-constraints.md` — Security rules
4. `docs/tasks/60-auth-internal-30-adr-clerk.md` — Why Clerk was chosen
5. `docs/tasks/60-auth-internal-40-guide-setup.md` — Setup instructions
...
- `01-config-biome-migration-50-ref-quickstart.md` — Usage documentation
...
- [ ] `docs/tasks/60-auth-internal-60-qa-checklist.md` — Mark items complete
