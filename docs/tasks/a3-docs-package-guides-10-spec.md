...
### Index README (`docs/package-guides/01-config-biome-migration-50-ref-quickstart.md`)
```markdown
# Package Guides
...
2. Read the package's own 01-config-biome-migration-50-ref-quickstart.md
...
2. Read package 01-config-biome-migration-50-ref-quickstart.md
...
grep -c "package-guides" 01-config-biome-migration-50-ref-quickstart.md
```
...
3. Add to `01-config-biome-migration-50-ref-quickstart.md` index
