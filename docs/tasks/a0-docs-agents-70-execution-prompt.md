...
3. **Relevant task documents in `docs/tasks/`**:
   ...
   - `*-10-spec.md` — How to build it
   - `*-20-constraints.md` — What not to do
4. **Target package documentation**:
   - `packages/[domain]/[package]/01-config-biome-migration-50-ref-quickstart.md`
...
Run through `a0-docs-agents-60-qa-checklist.md` and confirm:
