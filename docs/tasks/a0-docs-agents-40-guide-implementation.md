...
- [ ] Read relevant task documents in `docs/tasks/` (`*-00-overview.md`, `*-10-spec.md`)
- [ ] Read target package `01-config-biome-migration-50-ref-quickstart.md` and `CHANGELOG.md`
...
5. Document in package 01-config-biome-migration-50-ref-quickstart.md
...
1. **01-config-biome-migration-50-ref-quickstart.md** — Purpose, installation, usage examples
