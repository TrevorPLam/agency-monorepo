...
- Location: Repository root `01-config-biome-migration-50-ref-quickstart.md`
...
- **Package questions**: Check package-level 01-config-biome-migration-50-ref-quickstart.md
...
- [ ] File placed at root `01-config-biome-migration-50-ref-quickstart.md`
