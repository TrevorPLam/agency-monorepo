...
- `@/docs/tasks/13-config-prettier-10-spec.md` — Technical specification
- `@/docs/tasks/13-config-prettier-40-guide-usage.md` — Usage guide
- `@/docs/tasks/13-config-prettier-60-qa-checklist.md` — QA checklist
