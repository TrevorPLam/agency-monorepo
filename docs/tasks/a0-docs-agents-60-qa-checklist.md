...
- [ ] Task overview document (`*-00-overview.md`) has been read
- [ ] Task specification (`*-10-spec.md`) has been read
- [ ] Target package `01-config-biome-migration-50-ref-quickstart.md` has been read
...
- [ ] Package `01-config-biome-migration-50-ref-quickstart.md` updated if behavior changed
