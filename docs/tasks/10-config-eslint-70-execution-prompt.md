# 10-config-eslint-70-execution-prompt.md
...
3. `10-config-eslint-10-spec.md` - Detailed specification
4. `10-config-eslint-20-constraints.md` - Technical requirements
5. `10-config-eslint-30-adr-flatconfig.md` - Why flat config
...
4. `01-config-biome-migration-50-ref-quickstart.md` - Usage documentation
