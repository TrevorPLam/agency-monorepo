...
3. `docs/tasks/a1-docs-onboarding-20-constraints.md` — Environment requirements
4. `docs/tasks/a1-docs-onboarding-30-adr-tooling.md` — Why tools were chosen
5. `docs/tasks/a1-docs-onboarding-40-guide-setup.md` — Step-by-step instructions
...
Complete QA checklist from `a1-docs-onboarding-60-qa-checklist.md`.
