...
- `02-test-fixtures-constraints.md` - Detailed boundaries
- `03-test-fixtures-adr-faker-esm.md` - ESM requirements
- `04-test-fixtures-guide-domain-factories.md` - Factory patterns
