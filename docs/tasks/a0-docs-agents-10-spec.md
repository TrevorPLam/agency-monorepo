...
1. **Read the package's `01-config-biome-migration-50-ref-quickstart.md`** - Understand its purpose and consumers
...
- [ ] Referenced in root `01-config-biome-migration-50-ref-quickstart.md`
