...
**Decision:** Use a flat `docs/tasks/` directory with family-key-prefixed files and slot-band ordering.

**Rationale:**
- AI agents navigate deterministic naming and ordering more effectively than ad hoc files
...
```
docs/tasks/
├── a0-docs-agents-00-overview.md              # What this is
├── a0-docs-agents-10-spec.md                  # Complete AGENTS.md content
├── a0-docs-agents-20-constraints.md           # Hard boundaries
├── a0-docs-agents-30-adr-tooling.md           # This file — why this structure
├── a0-docs-agents-40-guide-implementation.md  # How to write agent-compliant code
├── a0-docs-agents-60-qa-checklist.md          # Validation steps
└── a0-docs-agents-70-execution-prompt.md      # Bounded implementation prompt
```
...
2. Task documents in `docs/tasks/` use ordered slot bands with family-key-prefixed filenames
...
5. AGENTS.md updates require corresponding task-document updates
