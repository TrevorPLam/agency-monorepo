...
1. `docs/tasks/e4-apps-client-portal-00-overview.md`
2. `docs/tasks/e4-apps-client-portal-10-spec.md`
3. `docs/tasks/e10-apps-client-sites-foundation-10-spec.md`
