...
- See `90-test-setup-20-constraints.md` for detailed boundaries
- See `90-test-setup-31-adr-turborepo-integration.md` for CI strategy
- See `90-test-setup-30-adr-server-components.md` for RSC testing rules
