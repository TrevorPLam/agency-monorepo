...
2. `01-config-biome-migration/01-config-biome-migration-30-adr.md` - Migration strategy and rationale
3. `01-config-biome-migration/01-config-biome-migration-40-guide-migration.md` - Step-by-step migration guide
4. `01-config-biome-migration/01-config-biome-migration-60-qa-checklist.md` - Quality assurance checklist
...
- `01-config-biome-migration-50-ref-quickstart.md` - Usage documentation and quick start guide
...
- `docs/tasks/` - Flat task corpus and build-order context
